<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="kozmetik.aspx.cs" Inherits="kozmetik" %>
...
<div id="icerik">
       		...
       		<div id="iceriksagust" class="h1">KOZMETİK ÜRÜNLERİ</div>
       		...
       		<div id="iceriksol"> 
 		     		<div id="iceriksolust1"></div>         
   					...
   					<div id="iceriksolust2" class="p1">
                          ...
                          <ItemTemplate>
                           <p>
                               <img src="images/ilanlar.gif" />&nbsp&nbsp&nbsp<a href="urundetay.aspx?id=<%#Eval("Id")%>"> <%#Eval("Baslik").ToString().ToUpper()%></a></p>
                          </ItemTemplate>
                           </asp:Repeater>
       		...
       		<div id="iceriksag">
       		  <div id="iceriksagust2"></div>         
                     ...
                     <asp:DataList ID="dlvitrin3" runat="server" CellPadding="4" 
